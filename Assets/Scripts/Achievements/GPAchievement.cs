...
public class GPAchievement
{
    ...
    private List<GPAchievement> dependencies_ = new List<GPAchievement>();
    ...
    public GPAchievement(string name, string description, int points, int spriteIndex, GameObject achievementRef, bool trophy)
    {
        this.name_ = name;
    ...
    public void AddDependency(GPAchievement dependency)
    {
